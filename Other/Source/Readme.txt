...
user in an INI file next to uTorrentPortable.exe called uTorrentPortable.ini.
...
copy AppNamePortable.ini from this directory to uTorrentPortable.ini next to
uTorrentPortable.exe. The options in the INI file are as follows:
